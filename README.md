...
Insert a record into the `LTI_13_AUTHZ` table with your tool's registration_id (`lms_reports`), along with the client_id 
...
<tr><td>Initiate login URL</td><td>http://localhost:8080/lti/login_initiation/lms_reports</td></tr>
